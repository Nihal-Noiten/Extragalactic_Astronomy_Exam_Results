...
fig_h.savefig("C2_Results_PNG/Histograms_R_t_end_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C2_Results_EPS/Histograms_R_t_end_CM_{:}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_h.savefig("C2_Results_PNG/Histograms_R_t_ini_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C2_Results_EPS/Histograms_R_t_ini_CM_{:}.eps".format(plotfile), bbox_inches='tight')
print()
print('Fig saved: Histograms, RF CM')
print()
...
fig_v.tight_layout()
fig_v.savefig("C2_Results_PNG/Histograms_V_t_ini_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_v.savefig("C2_Results_EPS/Histograms_V_t_ini_CM_{:}.eps".format(plotfile), bbox_inches='tight')
