...
fig_LR.savefig("C3_Results_PNG/Lagrangian_Radii_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_LR.savefig("C3_Results_EPS/Lagrangian_Radii_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_E.savefig("C3_Results_PNG/Energy_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_E.savefig("C3_Results_EPS/Energy_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_Phi.savefig("C3_Results_PNG/Potential_t_sample_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_Phi.savefig("C3_Results_EPS/Potential_t_sample_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_l.savefig("C3_Results_PNG/Angular_Momentum_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_l.savefig("C3_Results_EPS/Angular_Momentum_{:}.eps".format(plotfile), bbox_inches='tight')
...
fig_LRCM.savefig("C3_Results_PNG/Lagrangian_Radii_CM_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_LRCM.savefig("C3_Results_EPS/Lagrangian_Radii_CM_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_ECM.savefig("C3_Results_PNG/Energy_CM_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_ECM.savefig("C3_Results_EPS/Energy_CM_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_PhiCM.savefig("C3_Results_PNG/Potential_t_sample_CM_{:s}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_PhiCM.savefig("C3_Results_EPS/Potential_t_sample_CM_{:s}.eps".format(plotfile), bbox_inches='tight')
print()
...
for i in range(3):
	...
	if j == 1:
		...
		string_label = '{:.2f} $\%$ particles with $ x < 0 $ have '.format(100-pos) + r'$ v_{y} < 0$' + '\n' + '{:.2f} $\%$ particles with $ x > 0 $ have '.format(100-neg) + r'$ v_{y} > 0$'
		ax_V[i].hlines(0, xmin=-zoom, xmax=+zoom, color='black', lw=0.75, label=string_label)
	elif j == 3:
		string_label = '{:.2f} $\%$ particles with $ x < 0 $ have '.format(pos) + r'$ v_{z} > 0$' + '\n' + '{:.2f} $\%$ particles with $ x > 0 $ have '.format(neg) + r'$ v_{z} < 0$'
		ax_V[i].plot(0.,0., color='black', marker='o', markersize=0.15, ls='', label=string_label)
...
for i in range(3):
	fig_V[i].savefig("C3_Results_PNG/Velocity_Small_{:}_cmap_CM_{:}.png".format(i+1, plotfile), bbox_inches='tight', dpi=400)
	fig_V[i].savefig("C3_Results_EPS/Velocity_Small_{:}_cmap_CM_{:}.eps".format(i+1, plotfile), bbox_inches='tight')
...
fig_D.savefig("C3_Results_PNG/Density_Profile_Fit_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_D.savefig("C3_Results_EPS/Density_Profile_Fit_{:}.eps".format(plotfile), bbox_inches='tight')
...
fig_h.savefig("C3_Results_PNG/Histograms_R_t_end_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C3_Results_EPS/Histograms_R_t_end_CM_{:}.eps".format(plotfile), bbox_inches='tight')
print()
...
fig_v.tight_layout()
fig_v.savefig("C3_Results_PNG/Histograms_V_t_end_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_v.savefig("C3_Results_EPS/Histograms_V_t_end_CM_{:}.eps".format(plotfile), bbox_inches='tight')
...
fig_h.savefig("C3_Results_PNG/Histograms_R_t_ini_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C3_Results_EPS/Histograms_R_t_ini_CM_{:}.eps".format(plotfile), bbox_inches='tight')
print()
print('Fig saved: Histograms, RF CM')
print()
...
fig_v.tight_layout()
fig_v.savefig("C3_Results_PNG/Histograms_V_t_ini_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_v.savefig("C3_Results_EPS/Histograms_V_t_ini_CM_{:}.eps".format(plotfile), bbox_inches='tight')
