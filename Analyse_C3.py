...
for i in range(3):
	fig_V[i].savefig("C3_Results_PNG/Velocity_Tight_{:}_cmap_CM_{:}.png".format(i+1, plotfile), bbox_inches='tight', dpi=400)
	fig_V[i].savefig("C3_Results_EPS/Velocity_Tight_{:}_cmap_CM_{:}.eps".format(i+1, plotfile), bbox_inches='tight')
...
fig_v.tight_layout()
fig_h.savefig("C3_Results_PNG/Histograms_V_t_end_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C3_Results_EPS/Histograms_V_t_end_CM_{:}.eps".format(plotfile), bbox_inches='tight')
