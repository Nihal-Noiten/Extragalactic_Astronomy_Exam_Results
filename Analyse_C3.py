...
fig_h.savefig("C3_Results_PNG/Histograms_t_end_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_h.savefig("C3_Results_EPS/Histograms_t_end_CM_{:}.eps".format(plotfile), bbox_inches='tight')
print()
