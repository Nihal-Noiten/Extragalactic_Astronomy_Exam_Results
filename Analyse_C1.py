...
fig_l.savefig("C1_Results_PNG/Angular_Momentum_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_l.savefig("C1_Results_EPS/Angular_Momentum_{:}.eps".format(plotfile), bbox_inches='tight')
...
for i in range(3):
	fig_V[i].savefig("C1_Results_PNG/Velocity_Small_{:}_cmap_CM_{:}.png".format(i+1, plotfile), bbox_inches='tight', dpi=400)
	fig_V[i].savefig("C1_Results_EPS/Velocity_Small_{:}_cmap_CM_{:}.eps".format(i+1, plotfile), bbox_inches='tight')
...
fig_D.savefig("C1_Results_PNG/Density_Profile_Fit_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_D.savefig("C1_Results_EPS/Density_Profile_Fit_{:}.eps".format(plotfile), bbox_inches='tight')
