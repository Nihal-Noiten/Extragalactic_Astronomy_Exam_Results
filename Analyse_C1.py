...
fig_D.savefig("C1_Results_PNG/Density_Profile_CM_{:}.png".format(plotfile), bbox_inches='tight', dpi=400)
fig_D.savefig("C1_Results_EPS/Density_Profile_CM_{:}.eps".format(plotfile), bbox_inches='tight')
